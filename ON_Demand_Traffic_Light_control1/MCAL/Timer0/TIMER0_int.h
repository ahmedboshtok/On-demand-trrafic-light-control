...
ES_t TIMER0_enuSetSyncDelay(u32 Copy_uint32TimeMs);
ES_t TIMER0_enuSetAsyncDelay(u32 Copy_uint32TimeMs, void (*Copy_pfuncCallFunc) (void*), void* Copy_pvoidParameter);
